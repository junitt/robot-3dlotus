...
def main():
    ...
    if args.include_objects:
        output_file = os.path.join(args.output_dir, f'instr_unicolor_sam2.npy')
    else:
        output_file = os.path.join(args.output_dir, f'instr_unicolor_embeds_sam2_no_obj.npy')
    ...
    for target_labels in taskvars_target_labels.values():
        for target_label in target_labels:
            ...
            action_names.add(instr_trans(action_name))
