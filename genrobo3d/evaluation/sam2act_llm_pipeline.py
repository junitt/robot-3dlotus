...
class Sam2Actioner(Actioner):
    ...
    def prepare_motion_planner_input(
        self, rgb_images, pcd_images, plan, arm_links_info, gripper_pose, voxel_size=0.01, 
        rm_robot='none', num_points=4096, same_npoints_per_example=False,
        xyz_shift='center', xyz_norm=False, use_height=False,
        use_color=False, instr_include_objects=False,
    ):
    ...
    def predict(self, task_str, variation, step_id, obs_state_dict, episode_id, instructions, cache=None):
        ...
        batch = self.prepare_motion_planner_input(
            rgb_images, pcd_images, plan,
